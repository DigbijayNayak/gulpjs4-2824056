...
!function () {
  ...
  function Xc(c) {
    var l,
      ...
      L,
      u,
      d = (h = Sc(l = c), v = h.iconName, z = h.prefix, e = h.rest, a = kc(l), m = Ac(l), t = qc(l), s = Oc(l), r = jc(l), {
        iconName: v,
        ...
        if (s) {
          ...
          wc = new s(function (c) {
            yc || D(c).forEach(function (c) {
              if ("childList" === c.type && c.addedNodes.length > 0 && !pc(c.addedNodes[0]) && (O.searchPseudoElements && v(c.target), l(c.target)), "attributes" === c.type && c.target.parentNode && O.searchPseudoElements && v(c.target.parentNode), "attributes" === c.type && pc(c.target) && ~b.indexOf(c.attributeName)) if ("class" === c.attributeName) {
                var z = Cc(X(c.target)),
                  e = z.prefix,
                  a = z.iconName;
...
$(function () {
  ...
  $('#site-modal').on('show.bs.modal', function (event) {
    $(this).find('.modal-content img').attr('src', $(event.relatedTarget).data('highres'));
  });
